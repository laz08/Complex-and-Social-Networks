...
er_generator <- function(){
  ...
  for(i in iters){
      ...
      e = 0.02
      p = (1/n) + ((1+e)*log(n))/n # min probability of edge between two arbitrary edges
      er <- erdos.renyi.game(n,p)
      path <- append(path, average.path.length(er))
  }
  
  # One possible result, since it takes a while to compute...:
  # 1.250000 2.428571 2.256410 2.554023 3.126773 3.074624 3.591359 3.764517 4.165344 4.465225
