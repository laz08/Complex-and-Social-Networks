...
# Preliminary Results (No Altmann)
...
kable(aic_table_test,  
      caption="\\label{tab:table4}AIC difference of the Geometric test model",
...
```{r echo=FALSE, warning=FALSE}
kable(aic_table_test,  
      caption="\\label{tab:table6} AIC difference of the Zeta test model",
      col.names = c("Test Data", "Poisson", "Geometric", "Zeta", "Zeta($\\gamma$=2)", "RT Zeta"),
      align=rep('c', 6))
```
...
```{r echo=FALSE, warning=FALSE}
kable(aic_table,  
      caption="\\label{tab:table7}  AIC difference of our different languages' models",
      col.names = c("Test Data", "Poisson", "Geometric", "Zeta", "Zeta($\\gamma$=2)", "RT Zeta"),
      align=rep('c', 6))
```
...
```{r  warning=FALSE, echo=FALSE, out.width="300px", out.height="300px", fig.align="center"}
...
Next, we add the Altmann function to our set of distributions, to see if it will provide a better fit of our data. 
...
kable(aic_table_alt,  
      caption="\\label{tab:table8}  AIC difference of our different languages' models",
...
kable(coeffs_table_alt,  
      caption="\\label{tab:table9} Summary of the most likely parameters for Zeta test sequence",
      col.names = c("Test Data", "$\\lambda$", "q", "$\\gamma$", "$\\gamma_{2}$", "$k_{max}$", "$\\gamma$", "$\\delta$"),
      align=rep('c', 8))

```


# English comparison with Altmann
```{r  warning=FALSE, echo=FALSE, out.width="300px", out.height="300px", fig.align="center"}
#  c(6, 4, 2)  Ordered: English, Chinese, Basque
