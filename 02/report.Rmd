...
We can see that, in the case of the out-degree sequence, the method that fits best is almost exclusevily the Right-Truncated Zeta.
...
As we can see, the Right-Truncated Zeta distribution fits quite well, although not perfectly, with the three languages. Below, we plot the Basque language against the Geometric distribution, in order to show how poor of a fit it is. 
...
Figures 3, 4, and 5 ... to be continued
